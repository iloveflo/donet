...
INSERT INTO `chitiethoadonban` VALUES (1,3,6,49.00,1224000.00),(2,3,3,28.00,864000.00);
...
INSERT INTO `chitiethoadonnhap` VALUES (5,5,20,50000.00,15.00,0.00),(6,7,20,5000.00,15.00,0.00),(7,3,10,40000.00,15.00,0.00),(8,3,12,45000.00,5.00,0.00),(9,5,12,55000.00,15.00,0.00),(10,5,10,45000.00,15.00,382500.00),(11,5,10,50000.00,15.00,425000.00);
...
INSERT INTO `hoadonban` VALUES (1,NULL,'2025-03-18',NULL,2400000.00),(2,18,'2025-04-21','909',1200000.00);
...
INSERT INTO `hoadonnhap` VALUES (2,NULL,'2025-03-16',1,255000.00),(3,NULL,'2025-03-16',1,170000.00),(4,NULL,'2025-03-16',2,25000.00),(5,NULL,'2025-03-16',1,1000000.00),(6,NULL,'2025-03-16',3,100000.00),(7,NULL,'2025-03-16',3,400000.00),(8,NULL,'2025-03-16',4,540000.00),(9,NULL,'2025-03-16',5,660000.00),(10,NULL,'2025-03-16',5,450000.00),(11,18,'2025-04-21',2,500000.00);
...
INSERT INTO `khachhang` VALUES ('2','sfjbheskf','tb','0000009','2','binh456@gmail.com'),('5','jshfgksdsd','dgjhdjk','9847239434','5','binh123@gmail.com'),('909','binh0909','Tb','0963726321','909','25a4040713@hvnh.edu.vn');
...
CREATE TABLE `nhanvien` (
  ...
  KEY `fk_NhanVien_TaiKhoan` (`MaTaiKhoan`),
  CONSTRAINT `fk_NhanVien_TaiKhoan` FOREIGN KEY (`MaTaiKhoan`) REFERENCES `taikhoan` (`MaTaiKhoan`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `nhanvien` VALUES (18,'binh12','Nam','2000-06-06','097832324','HN','26a4040713@hvnh.edu.vn',1,'18');
...
INSERT INTO `sanpham` VALUES (3,'Váy mùa hè',3,3,3,2,2,2,3,103,'D:/ProjectC#/ClothingStore/ClothingStore/images/images (1).jpg',45000.00,400000.00),(5,'Khăn ấm',5,5,5,4,4,4,5,114,'D:/ProjectC#/ClothingStore/ClothingStore/images/tải xuống (2).jpg',50000.00,200000.00),(6,'quần đẹp',NULL,NULL,NULL,NULL,NULL,NULL,NULL,70,NULL,400000.00,900000.00),(7,'quần xấu',1,1,1,1,1,1,1,120,'D:/ProjectC#/ClothingStore/ClothingStore/images/tải xuống (4).jpg',5000.00,900000.00);
...
INSERT INTO `taikhoan` VALUES ('18','18','admin123','NhanVien'),('2','biwhd','123','KhachHang'),('5','binh001','12345678','KhachHang'),('909','binh0909','binh','KhachHang'),('admin','admin','456','Admin');
...
-- Dump completed on 2025-04-21 22:54:23
